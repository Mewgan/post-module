...
class LoadPostMedia extends AbstractFixture implements OrderedFixtureInterface
{
    private $data = [
        ...
        [
            'title' => 'Article 1',
            'path' => '/public/media/article-1.jpg',
            'type' => 'image/jpg',
            'size' => 10.86,
            'access_level' => 4,
            'scope' => 'global',
        ...
        [
            'title' => 'Article 2',
            'path' => '/public/media/article-2.jpg',
            'type' => 'image/jpg',
            'size' => 2577,
            'access_level' => 4,
            'scope' => 'global',
        ...
        [
            'title' => 'Article 3',
            'path' => '/public/media/article-3.jpg',
            'type' => 'image/jpg',
            'size' => 2577,
            'access_level' => 4,
            'scope' => 'global',
        ...
        [
            'title' => 'Article 4',
            'path' => '/public/media/article-4.jpg',
            'type' => 'image/jpg',
            'size' => 2577,
            'access_level' => 4,
            'scope' => 'global',
        ...
        [
            'title' => 'Article 5',
            'path' => '/public/media/article-5.jpg',
            'type' => 'image/jpg',
            'size' => 2577,
            'access_level' => 4,
            'scope' => 'global',
